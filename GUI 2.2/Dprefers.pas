...
//    NodeDigits: array[DEMAND..NODEQUAL] of Integer;
    NodeDigits: array[DEMAND..NODEVIEWS] of Integer;  //vrs 2.2
...
//  for i := DEMAND to NODEQUAL do
  for i := DEMAND to NODEVIEWS do   //vrs 2.2
  begin
...
//  for j := DEMAND to NODEQUAL do NodeUnits[j].Digits := NodeDigits[j];
  for j := DEMAND to NODEVIEWS do NodeUnits[j].Digits := NodeDigits[j];   //vrs 2.2
