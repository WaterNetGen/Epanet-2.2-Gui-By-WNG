...
of Embarcadero's Delphi 10 or with the Delphi 10 Community Version in
...
Dcalib2.pas   Selects parameter and locations to use for a 
              calibration report
Dchart.pas    Customizes the format of an existing X-Y graph
...
Dgraph.pas    Creates a specific type of X-Y graph and its contents
